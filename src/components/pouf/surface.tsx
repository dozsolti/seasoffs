...
const card = cva("bg-surface rounded-card pouf-card cushion-card", {
  variants: {
    variant: {
      default:
        "px-(--s7) pt-[calc(var(--s7)-var(--lip)/2)] pb-[calc(var(--s7)+var(--lip)/2)]",
      flush: "p-0",
      tight:
        "px-(--s5) pt-[calc(var(--s5)-var(--lip)/2)] pb-[calc(var(--s5)+var(--lip)/2)]",
    },
    motion: {
      none: "",
