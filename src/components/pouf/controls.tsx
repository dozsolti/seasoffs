  ...
  return (
    <RDialog.Root open={open} onOpenChange={onOpenChange}>
      <RDialog.Portal>
        ...
        <RDialog.Content
          className={
            size === "lg" ? "pouf-dialog pouf-dialog--lg" : "pouf-dialog"
          }
        >
          <Stack gap={4}>
...
export function Combobox({
  ...
  return (
    ...
    >
      ...
      <RPopover.Portal>
        <RPopover.Content
          className="pouf-popover pouf-popover--combobox"
          sideOffset={8}
          align="start"
        >
          <input
          ...
          >
            ...
            {!loading &&
              shown.map((o, i) => (
                <button
                  ...
                  className="flex-wrap justify-between min-w-0 pouf-option"
                  onClick={() => commit(o)}
            ...
            {!loading && !error && shown.length === 0 && !canCreate && (
              <div className="pouf-combobox__note">
                No models offered — type an id.
              </div>
            )}
          </div>
        </RPopover.Content>
