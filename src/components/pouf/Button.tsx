...
function LoadingSpinner() {
  return (
    <span
      className="border-[3px] border-[color-mix(in_srgb,currentColor_24%,transparent)] border-t-current border-solid rounded-[50%] size-[15px] [animation:pouf-spin_620ms_linear_infinite]"
      aria-hidden="true"
    />
  );
}
